...
export default function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <div className="bg-dark-2 border border-dark-3 rounded-2xl overflow-hidden group hover:border-gold/30 transition-all duration-300 flex flex-col">
      {/* Imagen */}
      <div className="aspect-square bg-dark-3 overflow-hidden relative">
        {product.imagen_url ? (
          <img
        ...
        {product.destacado && (
          <span className="absolute top-3 left-3 bg-gold text-dark text-xs font-bold px-2 py-1 rounded-lg">
            Destacado
          </span>
        )}
      </div>
